					...
					<ul>
						<li>
							<div class="recipe_subject">
								<!-- 요리 사진 -->
								<img class="food_img" alt="이 음식의 사진은 없습니다." src="../img/${dto.img_url}">
								<!-- 요리 제목 -->
								<div class="recipe_nm_ko" style="margin-top:60px;">제목: ${dto.recipe_nm_ko}</div>
								<!-- 요리 요약 -->
								<div class="mem_id">작성 셰프 : ${dto.mem_id}</div>
